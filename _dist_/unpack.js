import i from"./dup.js";import e from"./compiler.js";var a=e({args:["array","scalar","index"],pre:{body:"{}",args:[],thisVars:[],localVars:[]},body:{body:`{
